...
class Register(ABC):
    ...
    def _digest(self):
        ...
        return (
            hash_file(self._version_filepath).hexdigest(),
            hash_file(self._shorthand_filepath).hexdigest(),
            hash_file(self._msg_filepath).hexdigest(),
            hash_file(self._cls_filepath).hexdigest(),
            hash_file(self._db_map_size_filepath).hexdigest(),
            hash_file(self._perm_db_filepath / DATA_FILEPATH.name).hexdigest()
        )
            ...
            while front_index < len(queue):
                ...
                for subreg in Register._subregs_disk(r_txn):
                    ...
                    if subreg not in touched:
                        ...
                        touched.add(subreg)
                        ro_txn_stack.enter_context(subreg._manage_txn())
        ...
        with ExitStack() as post_yield: # see pattern VIII.1
            ...
            try:
                ...
                with ExitStack() as prior_yield:
                    ...
                    prior_yield.enter_context(self._manage_txn())
        ...
        with ExitStack() as post_yield: # see pattern VIII.1
            ...
            try:
                ...
                with ExitStack() as pre_yield:
                    ...
                    pre_yield.enter_context(self._manage_txn())
