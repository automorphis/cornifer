...
class Register(ABC):
    ...
    def _set_local_dir(self, local_dir):
        ...
        self._write_db_filepath = Path(read_txt_file(self._local_dir / WRITE_DB_FILEPATH).strip())
        ...
        for subreg in Register._subregs_disk(r_txn):
            ...
            if subreg not in touched:
                ...
                with subreg._recursive_open(True) as subreg:
                    ...
                    with subreg._txn("reader") as ro_txn:
            ...
            while front_index < len(queue):
                ...
                for subreg in Register._subregs_disk(r_txn):
                    ...
                    if subreg not in touched:
                        ...
                        touched.add(subreg)
                        ro_txn = ro_txn_stack.enter_context(subreg._txn("reader"))
